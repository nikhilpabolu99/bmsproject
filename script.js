document.addEventListener("DOMContentLoaded", () => {
    ...
    const fetchShowtimes = async () => {
                ...
                try {
                    ...
                    totalSummaryDetails += `<div class="movie-summary">
                        ...
                        <ul>
                            ...
                            <li><strong>Total Shows:</strong> ${movieTotalShows}</li>
                    ...
                    finalSummaryData.push({
                        ...
                        seatsAvail: movieSeatsAvail,
                        bookedTickets: movieBookedTickets,
                        shows: uniqueShows
                    });
        ...
        // Render movie-wise summary
        summaryContainer.innerHTML = totalSummaryDetails;
    ...
    // Attach event listener for Fetch button
